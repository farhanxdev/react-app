...
import soft from './photo/softower.jpg'
import web from './photo/web.jpg'
import mob from './photo/app.jpg'
import sc from './photo/cyber-security.jpg'
import email from './photo/gmail.png'
import whatsapp from './photo/whatsapp.png'
import facebook from './photo/facebook.png'
import instgram from './photo/instagram.png'
        ...
        <div style={{ backgroundColor: 'black' }}>
            <header style={{ backgroundColor: '#718720', paddingBottom: '5px', borderRadius: '5px' }}>
                ...
                <h1 style={{ textAlign: 'center', margin: 0, fontSize: 60 }}  >
                    ...
                    <span style={styleSpan}>O</span>
                    <span style={styleSpan}>N</span>
                    <span style={styleSpan}>E</span>

                </h1>
                <nav style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div style={{ color: 'white' }}  onClick={onClickAbout} >About</div>
                    <div style={{ color: 'white' }} onClick={onClickHome} >Home</div>
                    <div style={{ color: 'white' }} onClick={onClickContact} >Contact</div>
                </nav>
            </header>
            <Bodyelement/>
